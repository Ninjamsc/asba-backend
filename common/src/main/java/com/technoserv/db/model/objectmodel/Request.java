...
public class Request extends BaseEntity<Long> {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                ...
                .add("status", status)
                .add("scannedDocument", scannedDocument.getBioTemplates()==null || scannedDocument.getBioTemplates().size()==0 ? "no bio templates for document"+scannedDocument.getId() : scannedDocument )
                .add("cameraDocument",  cameraDocument.getBioTemplates()==null || cameraDocument.getBioTemplates().size()==0 ? "no bio templates for document"+cameraDocument.getId() : cameraDocument )
                .add("login", login)
                .add("insUser", insUser)
