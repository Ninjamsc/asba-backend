...
<div class="generic-container">
    <div class="authbar">
        <span> Зарегистрирован в панели управления как  <strong>${loggedinuser}</strong> </span> <span
            class="floatRight"><a href="<c:url value="/logout" />">Выход</a></span>
    </div>
    ...
    <form:form method="POST" modelAttribute="user" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <c:choose>
                    <c:when test="${edit}">
                        <input type="submit" alt="Обновить" value="Изменить" class="btn btn-primary btn-sm"/> или <a
                            href="<c:url value='/list' />">Отменить</a>
                    </c:when>
                    <c:otherwise>
                        <input type="submit" alt="Зарегистрировать" value="Зарегистрировать"
                               class="btn btn-primary btn-sm"/> или <a href="<c:url value='/list' />">Отменить</a>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
